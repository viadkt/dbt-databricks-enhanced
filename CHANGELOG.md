## dbt-databricks-enhanced 1.11.7.1 (TBD)

Rebased onto upstream `dbt-databricks` 1.11.7. All enhanced patches from 1.11.6.1 are carried over — see the 1.11.6.1 entry below for the full list. No new enhanced changes in this release beyond the upstream sync.
